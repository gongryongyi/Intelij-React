...
public class ReviewController {
    ...
    public ResponseEntity<PagingResponse> getReviews(@PathVariable final Long productCode,
                                                     @RequestParam(defaultValue = "1") final int page){

        final Page<ReviewResponse> reviews = reviewService.getReviews(page, productCode);
