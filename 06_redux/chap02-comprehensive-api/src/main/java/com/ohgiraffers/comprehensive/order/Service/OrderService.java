...
import static com.ohgiraffers.comprehensive.common.exception.type.ExceptionCode.ExceptionCode.NOT_ENOUGH_STOCK;
import static com.ohgiraffers.comprehensive.common.exception.type.ExceptionCode.ExceptionCode.NOT_FOUND_PRODUCT_CODE;

@Service
@RequiredArgsConstructor
@Transactional  //서비스에서는 Transactiona이 관리 되야한다.
